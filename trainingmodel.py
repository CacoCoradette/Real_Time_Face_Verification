...
from utils import LRN2D, conv2d_bn, weights, load_weights,triplet_loss
...
inception_3b_pool = Lambda(lambda x: tf.keras.backend.sqrt(x), name='sqrt_3b')(inception_3b_pool)
...
inception_4a_pool = Lambda(lambda x: tf.keras.backend.sqrt(x), name='sqrt_4a')(inception_4a_pool)
...
inception_5a_pool = Lambda(lambda x: tf.keras.backend.sqrt(x), name='sqrt_5a')(inception_5a_pool)
